        ...
        <div class="w-full lg:w-1/3 space-y-6">
          ...
          <div v-else class="bg-white rounded-3xl shadow-sm border border-slate-100 p-8 space-y-8">
            ...
            <div class="flex items-start gap-4">
              <div class="w-12 h-12 bg-primary-50 text-primary-600 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div class="flex items-start gap-4">
              <div class="w-12 h-12 bg-secondary-50 text-secondary-600 rounded-xl flex items-center justify-center flex-shrink-0">
            ...
            <div class="flex items-start gap-4">
              <div class="w-12 h-12 bg-teal-50 text-teal-600 rounded-xl flex items-center justify-center flex-shrink-0">
