      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-1">
          ...
          <p class="text-sm text-slate-400 leading-relaxed mb-5">
            O'zbekiston Respublikasi sog'liqni saqlash vazirligi — Andijon viloyati hokimligi sog'liqni saqlash boshqarmasi rasmiy veb-sayti.
          </p>
          <!-- Social Links -->
          <div class="flex items-center gap-3">
            ...
            <a href="#" class="w-9 h-9 rounded-lg bg-white/5 hover:bg-red-600 flex items-center justify-center transition-all duration-300 hover:-translate-y-0.5" aria-label="YouTube">
        ...
        <div>
          ...
          <div class="space-y-4">
            <div class="flex items-start gap-3">
              ...
              <p class="text-sm text-slate-400 leading-relaxed">710000, Andijon shahar, Amir Umarxon ko'chasi, 19-uy</p>
            </div>
            <div class="flex items-center gap-3">
